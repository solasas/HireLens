...
from app.services.llm.prompts.job_extraction import SYSTEM_INSTRUCTIONS, build_job_extraction_prompt
...
async def extract_job_description(job_description_text: str, *, llm: LLMProvider) -> JobExtraction:
    ...
    return await extract_with_retry(
        llm, system_instruction=SYSTEM_INSTRUCTIONS, prompt=prompt, schema=JobExtraction
    )
